...
public class Main {
    public static void main(String[] args){
        ...
        TreeSet<Studio> aprtsStusa = new TreeSet<>(Comparator.comparing(Studio::getApartmentNumber));
        ...
        switch (choicePrice) {
            case 1 -> manager.sortByPrice(availableDwellings, false);
            case 2 -> manager.sortByPrice(availableDwellings, true);
        ...
        switch (choiceLocation) {
            case 1 -> manager.sortByLocation(availableDwellings, false);
            case 2 -> manager.sortByLocation(availableDwellings, true);
            default -> System.out.println("Invalid choice");
        }
        System.out.println(availableDwellings);
